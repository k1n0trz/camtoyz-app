...
- MVP decidido: salas anónimas efímeras por código. Reevaluar cuentas antes de producción pública para que los bloqueos sean resistentes a reinstalaciones.
